...
export default class attendanceEdit extends Component {
  ...
  fetchDatas = () => {
    ...
    fetch('http://103.30.247.147:8000/api/schedule/' + scheduleId)
  ...
  fetchTeachersByStudent = (student) => {
    fetch('http://103.30.247.147:8000/api/teachers/filterStudent?student=' + student)
      .then(response => response.json())
      .then((json) => {
        this.setState({
          teachers: json.data
  ...
  onSubmit(e) {
    ...
    axios.patch('http://103.30.247.147:8000/api/schedule/'+this.props.scheduleId, obj)
