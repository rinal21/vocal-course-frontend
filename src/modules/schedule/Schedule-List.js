...
export default class schedulesList extends Component {
  ...
  async onChangeStartAt(e, id) {
    ...
    console.log(obj, id)
    axios.patch('http://103.30.247.147:8000/api/schedule/' + id, obj)
  ...
  async onChangeStudent(studentSelected, id) {
    ...
    console.log(obj)
    await axios.patch('http://103.30.247.147:8000/api/schedule/' + id, obj)
      .then(res => console.log(res.data))
      .catch(error => {
        isError = true
  ...
  async addRow() {
    return new Promise((resolve, reject) => {
      ...
      axios.post('http://103.30.247.147:8000/api/schedule', obj)
        .then(async () => {
          await this.promisedSetState({
            isLoaded: false
          })
  ...
  copySchedule = async () => {
    return new Promise((resolve, reject) => {
      ...
      axios.post('http://103.30.247.147:8000/api/schedules/copy', obj)
        .then(async () => {
          await this.promisedSetState({
            copyConfirm: false
          })
  ...
  fetchData = () => {
    return new Promise(async(resolve, reject) => {
      await fetch('http://103.30.247.147:8000/api/schedules?branch=' + JSON.parse(localStorage["appState"]).user.branchId)
      .then(response => response.json())
      .then( (json) => {
  ...
  filterData = (filterDate, isChangeClass, classId) => {
    ...
    let url = 'http://103.30.247.147:8000/api/schedules/filter?'+obj
    return new Promise((resolve, reject) => {
    fetch(url)
      .then(response => response.json())
      .then(async(json) => {
