...
export default class attendancesList extends Component {
  ...
  async onChangeStudentStatus(e, id){
    ...
    axios.patch('http://103.30.247.147:8000/api/attendance/' + id, obj)
      ...
      if(e.target.value == '3') {
        axios.patch('http://103.30.247.147:8000/api/user_decbalance/' + this.state.studentSelected[id].value)
          .then(res => console.log(res.data))
          .catch(error => {
            console.log(error.message);
          })
      ...
      axios.post('http://103.30.247.147:8000/api/transaction', objTransaction)
          .then(res => console.log(res.data))
...
async onChangeEndAt(e, id) {
  ...
  fetchStudentsByClass = (id) => {
    fetch('http://103.30.247.147:8000/api/students/filterClass?status=3&classId=' + id)
  ...
  onChangeClass = async (e, id) => {
    ...
    console.log(obj, id)
    await axios.patch('http://103.30.247.147:8000/api/attendance/' + id, obj)
      .then(res => console.log(res.data))
      .catch(error => {
        console.log(error.message);
      })
  ...
  fetchData = () => {
    return new Promise(async(resolve, reject) => {
      await fetch('http://103.30.247.147:8000/api/attendances')
      .then(response => response.json())
      .then( (json) => {
  ...
  fetchStudentsByClass = (name) => {
    return new Promise((resolve, reject) => {
    fetch('http://103.30.247.147:8000/api/students/filterClass?class=' + name)
      .then(response => response.json())
      .then((json) => {
        this.setState(prevState => ({
          students: [...prevState.students, json]
  ...
  fetchRooms = () => {
    return new Promise((resolve, reject) => {
    fetch('http://103.30.247.147:8000/api/rooms')
      .then(response => response.json())
      .then((json) => {
  ...
  filterData = (filterDate, isChangeClass, classId) => {
    let url = classId ? 'http://103.30.247.147:8000/api/attendances/filter?classId='+ classId +'&date='+moment(filterDate).format("YYYY-MM-DD") : 'http://103.30.247.147:8000/api/attendances/filter?date='+moment(filterDate).format("YYYY-MM-DD")
    return new Promise((resolve, reject) => {
    fetch(url)
      .then(response => response.json())
      .then(async(json) => {
