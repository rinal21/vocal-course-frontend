...
export default class studentList extends Component {
  ...
  delete(id) {
    axios.delete('localhost:8000/api/student_attendance/' + id)
  ...
  fetchData = () => {
    fetch('localhost:8000/api/student_attendances')
  ...
  filterData = (filterDate) => {
    fetch('localhost:8000/api/student_attendances/filterDate?date=' + moment(filterDate).format("YYYY-MM-DD"))
      .then(response => response.json())
      .then((json) => {
        this.setState({
          students: json
