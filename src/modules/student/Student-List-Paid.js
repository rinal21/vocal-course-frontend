...
export default class studentListPaid extends Component {
  ...
  onChangeGroupingOption(e) {
    ...
    fetch('http://103.30.247.147:8000/api/students/groupingClass?grouping=' + e.target.value + '&status=3')
  ...
  fetchStudentsByBranch = (id) => {
    fetch('http://103.30.247.147:8000/api/students/filterBranch?status=3&branchId=' + id)
      .then(response => response.json())
      .then((json) => {
        this.setState({
          students: json
  ...
  toggleDetailStudent = (id) => {
    if (id) {
      ...
      fetch('http://103.30.247.147:8000/api/student_transaction/' + id)
      .then(response => response.json())
      .then((json) => {
        this.setState({
          transactions: json
  ...
  filterData = (filterDate) => {
    fetch('http://103.30.247.147:8000/api/students/filterYear?status=3&date=' + filterDate)
      .then(response => response.json())
      .then((json) => {
        this.setState({
          students: json
