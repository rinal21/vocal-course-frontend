...
export default class studentListAll extends Component {
  constructor(props) {
    super(props)
  ...
  filterData = (filterDate) => {
    fetch('http://localhost:8000/api/students/filterYear?status=students.status&date=' + filterDate)
      .then(response => response.json())
      .then((json) => {
        this.setState({
          students: json
  ...
  fetchData = () => {
    fetch('http://localhost:8000/api/students?status=students.status')
      .then(response => response.json())
      .then((json) => {
        this.setState({
          students: json
